...
.content{min-width:0;overflow:auto;background:#fff}.empty,.error{padding:24px;color:var(--muted)}.render{padding:22px}.render iframe{width:100%;height:calc(100vh - 88px);border:1px solid var(--line);background:white}.render img{display:block;max-width:100%;height:auto}.sourceview{min-height:100%;background:var(--code)}.sourceview pre[class*="language-"].sourcepre,.sourceview code[class*="language-"]{background:var(--code)!important;text-shadow:none}.sourceview .token{background:transparent!important}.sourceview a{color:inherit;text-decoration:underline;text-decoration-color:rgba(255,255,255,.35)}pre[class*="language-"].sourcepre{min-height:100vh;margin:0;border-radius:0;font-size:13px;line-height:1.55}.line-highlight{background:rgba(255,255,255,.14)}
