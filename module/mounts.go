...
@media (max-width:720px){.shell{grid-template-columns:minmax(180px,76vw) 6px 1fr}.tokeninput{width:150px}.side-title{display:none}}
</style>
</head>
<body>
<div id="shell" class="shell">
  ...
  <main class="main">
    <div class="topbar"><button class="icon" id="expand" title="Show sidebar">&#9776;</button><div id="breadcrumb" class="breadcrumb"><span class="crumb">No file selected</span></div><div class="grow"></div><span id="authstate" class="authstate">Locked</span><input id="token" class="tokeninput" type="password" autocomplete="off" placeholder="Bearer token"><button id="unlock" class="unlock">Unlock</button><div class="seg"><button id="renderMode" class="active">Render</button><button id="sourceMode">Source</button></div></div>
